...
grep -q "CONTRACTS" /tmp/marchcal.log 2>/dev/null && M1=PASS || M1=FAIL
...
M4=$( [ -f sigma_grid_spread.txt ] && awk '$1<0.15{print "PASS";exit}END{print "FAIL"}' sigma_grid_spread.txt || echo FAIL )
